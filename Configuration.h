...
#define STRING_CONFIG_H_AUTHOR "Agustín Mayer" // Who made the changes.
...
//aj#define SHOW_CUSTOM_BOOTSCREEN
...
#define CUSTOM_MACHINE_NAME "3D Matik V2"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 8000, 5000 }
